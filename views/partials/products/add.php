                            ...
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <label class="control-label" for="product_category_id">Product Category Id <span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-product_category_id"  value="<?php  echo $this->set_field_value('product_category_id',""); ?>" type="number" placeholder="Enter Product Category Id" step="1"  required="" name="product_category_id"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-stock"  value="<?php  echo $this->set_field_value('stock',"0"); ?>" type="number" placeholder="Enter Stock" step="1"  required="" name="stock"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <label class="control-label" for="stock_defective">Stock Defective <span class="text-danger">*</span></label>
                                                        </div>
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-stock_defective"  value="<?php  echo $this->set_field_value('stock_defective',"0"); ?>" type="number" placeholder="Enter Stock Defective" step="1"  required="" name="stock_defective"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <input id="ctrl-deleted_at"  value="<?php  echo $this->set_field_value('deleted_at',""); ?>" type="text" placeholder="Enter Deleted At"  required="" name="deleted_at"  class="form-control " />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
