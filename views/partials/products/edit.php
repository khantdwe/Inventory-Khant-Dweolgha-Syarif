                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-product_category_id"  value="<?php  echo $data['product_category_id']; ?>" type="number" placeholder="Enter Product Category Id" step="1"  required="" name="product_category_id"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
