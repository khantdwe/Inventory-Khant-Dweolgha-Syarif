                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-transfer_id"> Transfer Id</th>
                                                <th  class="td-payment_method_id"> Payment Method Id</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-id"><a href="<?php print_link("transactions/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
                                                    <td class="td-type">
