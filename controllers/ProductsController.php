...
class ProductsController extends SecureController{
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("name","description","product_category_id","price","stock","stock_defective","created_at","updated_at","deleted_at");
			...
			$this->sanitize_array = array(
				...
				'product_category_id' => 'sanitize_string',
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","name","description","product_category_id","price","stock","stock_defective","created_at","updated_at","deleted_at");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'name' => 'required',
